...
os.system('clear')
print(' \x1b[38;5;46mROKY SERVER LOADING....')
...
sys.stdout.write('\x1b]2;𓆩【ROKY】𓆪 \x07')
    ...
    # ROKY Clover Logo - Green - Version 2.5
def ____banner____():
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/RAKIB-ROKY-009/OLD-ID/blob/main/Approval.txt').text
    if id in httpCaht:
      ...
      print("Your Token :\33[1;32m"+id)
      print('\33[1;37m----------------------------------------------')
      print("\33[1;32mSEND ME KEY WHATSAPP")
      print("\33[1;37m----------------------------------------------")
     # print('\33[1;37m----------------------------------------------')
      input('IF U WANT TO BUY THEN PRESS ENTER⇨')
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801315107214?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
